...
\subtitle{\LaTeX 2: Structured Documents \& More}
...
\begin{itemize}
\item Use the \bftt{biblatex} package with the \bftt{natbib} option.
\item The bibliography file must be called using the \cmdbs{addbibresource} command.
\item At the end, print the bibliography using \cmdbs{printbibliography}.
\end{itemize}
\begin{minipage}{0.55\linewidth}
\inputminted[fontsize=\scriptsize,frame=single,resetmargins]{latex}%
  {bib-example.tex}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]{\insertsubsection{} 4}

\begin{itemize}
\item Several \bftt{style} to choose from (\bftt{apa}, \bftt{numeric}, \bftt{authoryear}, and other journal styles too). See this \href{https://www.overleaf.com/learn/latex/Biblatex_citation_styles}{link}.
\item Previously, the package \bftt{bibtex} and \bftt{natbib} were very commonly used; and these provided several citation commands such as \cmdbs{citet}, \cmdbs{citep}, \cmdbs{citeyear}, etc. See this \href{https://www.overleaf.com/learn/latex/Natbib_citation_styles}{link}.
\item The \bftt{biblatex} package provides much more customisation to your bibliography.
\begin{itemize}
%\item Sorting options: \bftt{sort=none}, etc. 
\item Change the title: \cmdbs{printbibliography[title=\{My title\}]}
\item Print only certain types: \cmdbs{printbibliography[type=article,title=\{Articles only\}]}, 
\cmdbs{printbibliography[keyword=\{physics\},title=\{Physics-related only\}]}
\item Adding bibliography to TOC: \cmdbs{printbibliography[heading=bibintoc]}
\end{itemize}

\end{itemize}

For more customisation options, see the package \href{https://mirror.marwan.ma/ctan/macros/latex/contrib/biblatex/doc/biblatex.pdf}{documentation}. 
