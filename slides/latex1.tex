...
\blfootnote{Based on the \texttt{latex-course} slides by Dr. JL Miller (MIT License). See \href{https://github.com/jdleesmiller/latex-course}{\texttt{jdlessmiller/latex-course}} GitHub repo for more details. }
